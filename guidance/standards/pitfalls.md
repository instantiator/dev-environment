...
- **`TODO` / `LATER` / `qq` without a condition** — every deferred item MUST say WHEN or under what CONDITIONS it should be dealt with. Add the condition (ask the user if unclear), then decide whether to tackle it now.
