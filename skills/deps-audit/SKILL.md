...
4. Update in small groups (security first), running `dev-environment/scripts/check.sh` after each group — not one giant bump.
...
- `dev-environment/scripts/check.sh` after each update group
